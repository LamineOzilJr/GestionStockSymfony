...
use App\Repository\ProduitcRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ProduitcRepository::class)]
class Produitc
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'produit', targetEntity: Entreec::class, orphanRemoval: true)]
    private $entrees;

    #[ORM\OneToMany(mappedBy: 'produit', targetEntity: Sortiec::class, orphanRemoval: true)]
    private $sorties;
    ...
    public function addEntree(Entreec $entree): self
    {
    ...
    public function removeEntree(Entreec $entree): self
    {

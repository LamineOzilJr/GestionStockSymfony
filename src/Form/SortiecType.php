...
class SortiecType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('boutique', EntityType::class, array('class'=>Boutique::class,'label'=>'Boutique a livrer', 'attr'=>array('require'=>'require','class'=>'form-control form-group')))
